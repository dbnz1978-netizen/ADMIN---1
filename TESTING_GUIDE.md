...
- ✓ Меню "Новости" НЕ видно в сайдбаре
- ✓ При прямом открытии URL: редирект на `/admin/logout.php`
- ⚠️ Страница настроек `/plugins/news-plugin/pages/settings/access.php` требует роль admin, при попытке доступа не-администратора происходит редирект на logout

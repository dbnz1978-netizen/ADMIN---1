<?php
/**
 * Файл: /admin/record/add_record.php
 *
 * Назначение:
        ...
        if (empty($errors)) {
            try {
                ...
                if ($isEditMode && $itemId) {
                    ...
                    header("Location: add_record.php?id=$itemId");                    
                    exit;
                    ...
                    header("Location: add_record.php?id=" . $newId);
                    exit;
                }
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-lg-6">
                        <h3 class="card-title d-flex align-items-center gap-2 mb-0">
                            ...
                            <?= $isEditMode ? 'Редактировать новость' : 'Добавить новость' ?>
                        </h3>
                    </div>

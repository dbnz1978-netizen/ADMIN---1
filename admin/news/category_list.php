<?php
/**
 * Файл: /admin/record/category_list.php 
 *
 * Назначение:
 ...
 * - Отбор записей идёт по related_table (например 'record') — это удобно, если в одной таблице
                        ...
                        <form method="GET" class="d-flex mb-3">
                            ...
                            <div class="input-group" style="gap: 2px;">
                                ...
                                <?php if ($search !== '' || $search_catalog !== ''): ?>
                                    <a href="<?= $isTrash ? '?trash=1' : 'category_list.php' ?>"

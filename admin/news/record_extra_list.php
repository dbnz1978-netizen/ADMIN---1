<?php
/**
 * Файл: /admin/record/record_extra_list.php
 *
 * Назначение:
 * - Админ-страница со списком дополнительных элементов каталога (таблица record_extra).
 ...
 *
 * Важно:
 * - Таблица record_extra задаётся в настройках ($catalogTable) — меняется в одном месте.
...
// =============================================================================
// ПОЛУЧЕНИЕ ДАННЫХ ИЗ ТАБЛИЦЫ record_extra (с фильтром users_id И author)
            ...
            <div class="row align-items-center mb-4">
                <div class="col-lg-6">
                    <h3 class="card-title d-flex align-items-center gap-2 mb-0">
                        ...
                        <?= $isTrash ? 'Корзина' : 'Описание записи' ?>
                    </h3>
                </div>
                <div class="col-lg-6 text-end">
                    <a href="add_record_extra.php?author=<?= $authorId ?>"
                        ...
                        <?php else: ?>
                            <?php foreach ($users as $row): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="add_record_extra.php?id=<?= (int)$row['id'] ?>&author=<?= $authorId ?>" class="user-link text-decoration-none">
                                            <?= escape($row['naime'] ?? '') ?>
                                        </a>
                                    ...
                                    <td>
                                        <div class="btn-group" style="gap: 4px;">
                                            <a href="add_record_extra.php?id=<?= (int)$row['id'] ?>&author=<?= $authorId ?>"

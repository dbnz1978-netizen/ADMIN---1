<?php
/**
 * Файл: /admin/shop/product_list.php
 *
 * Назначение:
    ...
    <main class="main-content">
        ...
        <div class="content-card table-card">
            <div class="row align-items-center mb-4">
                <div class="col-lg-6">
                    <h3 class="card-title d-flex align-items-center gap-2 mb-0">
                        ...
                        <?= $isTrash ? 'Корзина' : 'Управление товаром' ?>
                    </h3>
                </div>
            ...
            <?php if (!$isTrash): ?>
                ...
                <?php endif; ?>
            <?php else: ?>
                <a href="product_list.php" class="btn btn-outline-primary mb-3">
                    ...
                    <?php else: ?>
                        <?php foreach ($users as $row): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="add_product.php?id=<?= (int)$row['id'] ?>" class="user-link text-decoration-none">
                                        <?= escape($row['naime'] ?? '') ?>
                                    </a>
                                ...
                                <td>
                                    <div class="btn-group" style="gap: 4px;">
                                        <a href="add_product.php?id=<?= (int)$row['id'] ?>"

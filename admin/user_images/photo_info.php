...
/**
 * Название файла:      photo_info.php
 * Назначение:          Шаблон кастомного модального окна для отображения информации о медиафайле
 *                      Используется в галерее пользовательских изображений для просмотра и редактирования
 *                      метаданных файла (alt-текст, размеры, дата загрузки и др.)

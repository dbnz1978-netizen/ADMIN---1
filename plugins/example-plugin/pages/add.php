...
/**
 * Название файла:      add.php
 * Назначение:          Пример страницы плагина - добавление страницы
...
<head>
    ...
    <title>Добавить страницу - Example Plugin</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
</head>
<body>
    <div class="container mt-5">
        <h1>Добавить страницу</h1>
        <p>Это пример страницы плагина. Здесь может быть форма добавления страницы.</p>

 ...
 * Назначение:          Админ-страница со списком дополнительных элементов новостей (таблица news_extra_content).
 ...
 * Важно:               - Таблица news_extra_content задаётся в настройках ($catalogTable) — меняется в одном месте.

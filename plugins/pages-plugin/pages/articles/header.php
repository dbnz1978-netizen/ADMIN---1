...
<div class="mb-3">
    <?php if (isset($_GET['page_id']) && !empty($_GET['page_id']) && is_numeric($_GET['page_id'])) { ?>
        <a href="add_article.php?id=<?= isset($_GET['page_id']) ? (int)$_GET['page_id'] : 0; ?>" 
            class="btn btn-primary btn-sm tooltip-example">
            <i class="bi bi-arrow-left"></i> Вернуться к странице 
        </a>
    <?php }  ?>
    ...
    ?>
    <a href="extra_list.php?page_id=<?= isset($_GET['page_id']) ? (int)$_GET['page_id'] : (int)$_GET['id']; ?>" 

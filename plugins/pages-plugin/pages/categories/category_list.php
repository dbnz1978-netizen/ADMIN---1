 ...
 * Назначение:          Админ-страница со списком категорий страниц.
...
$catalogTable      = 'pages_categories';                   // Название таблицы
$categoryUrlPrefix = 'page-category';                      // Префикс URL категории
                ...
                try {
                    ...
                    if ($errorCode === '23000' || $mysqlErrorCode === 1451) {
                        if ($action === 'delete' && $isTrash) {
                            $errors[] = 'Невозможно удалить категорию: на неё ссылаются страницы или другие записи. Сначала удалите или переместите связанные записи.';
                        } else {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $rowImage = getRecordAvatar(
                                                ...
                                                $catalogTable              // Название таблицы (например: 'pages_categories')
                                            );
                                        ?>

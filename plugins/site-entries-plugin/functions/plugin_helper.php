<?php
/**
 * Файл: /plugins/site-entries-plugin/functions/plugin_helper.php
 * 
 ...
 * 
 * @return string Имя плагина (например: 'site-entries-plugin')
 * 
 * @example
 * // Для файла /plugins/site-entries-plugin/pages/articles/add_article.php
 * $pluginName = getPluginName(); // Вернёт 'site-entries-plugin'
 * 

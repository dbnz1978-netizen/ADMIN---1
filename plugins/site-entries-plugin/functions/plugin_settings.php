<?php
/**
 * Файл: /plugins/site-entries-plugin/functions/plugin_settings.php
 * 
 * Функции для работы с настройками плагина site-entries-plugin, хранящимися в таблице plugins.
 * 
 * Настройки хранятся в колонке settings (TEXT, JSON) для записи с name='site-entries-plugin'.
 * Структура JSON:
 * {
 *   "image_sizes": {
 ...
 * @param string $pluginName Имя плагина (например: 'site-entries-plugin')

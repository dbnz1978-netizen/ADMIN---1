 ...
 * Назначение:          Админ-страница со списком категорий записей.
 ...
 * Автор:               Site Entries Plugin Team
 * Версия:              1.0
...
$titlemetah3       = 'Управление категориями записей';               // Название заголовка H2 для раздела
$catalogTable      = 'site_entries_categories';                    // Название таблицы
                ...
                try {
                    ...
                    if ($errorCode === '23000' || $mysqlErrorCode === 1451) {
                        if ($action === 'delete' && $isTrash) {
                            $errors[] = 'Невозможно удалить категорию: на неё ссылаются записи или другие записи. Сначала удалите или переместите связанные записи.';
                        } else {
                                    ...
                                    <tr>
                                        ...
                                        <?php
                                            ...
                                            $rowImage = getRecordAvatar(
                                                ...
                                                $catalogTable              // Название таблицы (например: 'site_entries_categories')
                                            );
                                        ?>

 ...
 * Назначение:          Страница настроек доступа к плагину "Записи сайта" по ролям пользователей.
...
$titlemeta     = 'Настройки';
$titlemetah3   = 'Управление доступом к плагину "Записи сайта"';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!ctype_digit($maxDigitsAddArticle) || (int)$maxDigitsAddArticle < 0 || (int)$maxDigitsAddArticle > 1000) {
        $validationErrors[] = 'Лимит изображений для добавления записи должен быть от 0 до 1000';
    }
            ...
            <form method="POST" action="<?= escape($_SERVER['PHP_SELF']) ?>">
                ...
                <div class="form-section">
                    ...
                    <div class="mb-4">
                        <p>
                            ...
                            Эти настройки применяются только к плагину "Записи сайта" и не влияют на другие разделы системы.
                        </p>
                        <p>
                ...
                <div class="form-section mb-5">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label">Добавление записи сайта (add_article.php)</label>
                            ...
                            <div class="form-text">Максимум изображений при добавлении записи</div>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="mb-3">
                    ...
                    <a href="/plugins/site-entries-plugin/pages/articles/article_list.php" class="btn btn-outline-secondary">
